...
def network_summary(graph):
    ...
    return summary
# network_summary(G)
with open(r"../files/proposed_robust.pickle", "rb") as input_file:
...
for i,j in store.keys():
    ...
    # coefficient = store[(i,j)]["robust_ef"]
    coefficient = store[(i,j)]["robust_lcc"]
...
#     plt.savefig('../plots/new_track/new/network_opt_44.png')
#     plt.show()

    # import _pickle as cPickle
with open(r"../files/iterations/lcc_10tracks_rider_0.pickle", "wb") as output_file:
